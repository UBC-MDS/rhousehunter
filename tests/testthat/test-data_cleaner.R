...
testthat::test_that("The cleaned tibble should have the same rows as the input tibble", {
...
testthat::test_that("The columns of the output tibble should have correct names ready for future filtering", {
  testthat::expect_equal(colnames(output_df), c("listing_url", "price", "num_bedroom", "area_sqft", "city"))
})
...
testthat::test_that("The scraped data frame contains data in toy dataset", {
  testthat::expect_true(dplyr::all_equal(output_df, toy_cleaned_df))
})
