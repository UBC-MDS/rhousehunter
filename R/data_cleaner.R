...
data_cleaner <- function(scraped_df) {
  ...
  city_list <- c("Bowen Island", "Burnaby", "Coquitlam", "Delta", "Langley", "Maple Ridge", "New Westminster",
                 "North Vancouver", "Pitt Meadows", "Port Coquitlam", "Port Moody", "Richmond", "Surrey", "Vancouver",
